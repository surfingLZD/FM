...
default_path="/Users/mac/Documents/programming/RS/FM/"
...
train = pd.read_csv(default_path+'data/ua_base.txt',delimiter='\t',names = cols)
test = pd.read_csv(default_path+'data/ua_test.txt',delimiter='\t',names = cols)
